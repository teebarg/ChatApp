...
//    }
    ...
    //    dd($e);
        if ($e instanceof CustomException) {
            ...
            return ResponseHelper::createErrorResponse(ResponseMessages::FAILED_VALIDATION, ResponseCodes::FAILED_VALIDATION, $data);
...
//            $data = ['contextData' => $e->getContextData()];
//            dd($e->guards());
            return ResponseHelper::createErrorResponse($e->getMessage(), ResponseCodes::RESOURCE_AUTHORISATION_ERROR, []);
